...
| 2026-04-16 | f5b16f47 | (pending) | fix(loss): align SpectralLoss with pDFNet2 paper defaults | under_suppression_weight 2.0→1.0 (paper symmetric); gamma 0.6→1.0 (official default) | Conditioning collapse from asymmetric loss | — |
